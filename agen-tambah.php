...
?>
    <div class="page-header page-header-photo"><div class="container">
        <p class="eyebrow mb-2">Panel Admin</p><h1 class="mb-2">Tambah Agen</h1><p class="lead mb-0">Tambahkan agen sales baru untuk menangani properti.</p>
    </div></div>
